...
public class UserConfiguration : IEntityTypeConfiguration<User>
{
    public void Configure(EntityTypeBuilder<User> builder)
    {
        ...
        builder.Property(x => x.FirstName).HasColumnName("FirstName").IsRequired().HasMaxLength(40);
        builder.Property(x => x.LastName).HasColumnName("LastName").IsRequired().HasMaxLength(40);
